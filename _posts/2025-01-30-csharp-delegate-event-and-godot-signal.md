...
tags: [C#, Godot]
author: copyrat90
last_modified_at: 2025-04-25T10:42:00+09:00
---
...
그 경우 장치 I/O가 끝나면 [C# 런타임이 갖고 있는 IOCP 내 worker thread pool에서 I/O Completion Packet을 처리한다.](https://blog.stephencleary.com/2013/11/there-is-no-thread.html)\
(정확히는, .NET 7 이전 Windows 기준, `SynchronizationContext.Current`가 기본값 `null`인 경우.)\
